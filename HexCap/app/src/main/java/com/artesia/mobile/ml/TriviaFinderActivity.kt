...
import com.artesia.mobile.ui.trivia.TriviaActivity
import com.artesia.mobile.util.YuvToRgbConverter
...
class TriviaFinderActivity : AppCompatActivity(), PredictionCallback {
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        private val templeModel = TempleModel.newInstance(ctx)
        ...
        override fun analyze(imageProxy: ImageProxy) {
            ...
            val outputs = templeModel.process(tfImage)
